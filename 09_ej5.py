""" Heladeria: Una heladeria es un tipo específico de restaurante. Escribe una 
clase llamada IceCreamStand que herede de la clase Restaurante que escribiste en
el Ejercicio 9-1 o en el Ejercicio 9-4. 
Agregue un atributo llamado sabor que almacena una lista de sabores de helado. 
Escriba un método que muestre estos tipos. Cree una instancia de IceCreamStand y 
llame a este método."""
...
helado = IceCreamStand("Grido","heladeria")
helado.describe_restaurant()
helado.sabor_disponible()
